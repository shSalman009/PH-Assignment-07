...
export default async function FriendDetails({ params }) {
  ...
  return (
    <div className="container mx-auto px-4 grid lg:grid-cols-3 grid-cols-1 lg:gap-x-6 gap-y-6 py-12">
      ...
      <div className="col-span-2 space-y-6">
        ...
        <div className="bg-base-100 shadow rounded-md sm:p-8 p-4">
          ...
          <div className="flex gap-4">
            <button className="btn sm:btn-xl btn-lg flex-col h-auto p-6 font-medium grow">
